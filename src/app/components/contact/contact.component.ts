    ...
    <section id="contact" class="py-20 bg-gray-100">
      <div class="container mx-auto px-6">
        ...
        <div class="max-w-2xl mx-auto">
          <form [formGroup]="contactForm" (ngSubmit)="onSubmit()" class="space-y-6" [@formAnimation]>
            <div>
            ...
            <div>
              ...
              <textarea formControlName="message"
                        rows="5"
                        class="w-full px-4 py-3 rounded-lg border focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors"></textarea>
            </div>
            <button type="submit"
