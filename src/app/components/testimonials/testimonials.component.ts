  ...
  template: `
    <section id="testimonials" class="py-20 bg-gray-50 dark:bg-gray-900">
      <div class="container mx-auto px-6">
        <h2 class="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-white">Testimonials</h2>
          ...
          @for (testimonial of testimonials; track testimonial.author) {
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <div class="flex items-center">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 dark:text-white">{{ testimonial.author }}</h4>
