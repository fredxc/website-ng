  ...
  template: `
    ...
    >
      <div class="container mx-auto px-6">
        ...
        <div
          class="max-w-3xl mx-auto text-gray-600 dark:text-gray-300 space-y-6"
        >
          <p>
            With over a decade of experience in frontend development, I
            specialize in creating performant and scalable web applications. My
            expertise lies in Angular and modern web technologies.
          </p>
          <p>
